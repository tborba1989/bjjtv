...
import { InscricaoForm } from '../pages/Inscricao';
...
const getEventImage = (id, imageUrl) => {
  ...
  // Se a URL já for um caminho completo (http/https), usa ela diretamente
  if (imageUrl.startsWith('http')) {
    return imageUrl;
  }

  // Caso contrário, constrói o caminho para a pasta de imagens local
